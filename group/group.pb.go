...
func (c *groupClient) GetJoinedGroupIDs(ctx context.Context, in *GetJoinedGroupIDsReq, opts ...grpc.CallOption) (*GetJoinedGroupIDsResp, error) {
	out := new(GetJoinedGroupIDsResp)
	err := c.cc.Invoke(ctx, "/OpenIMServer.group.group/getJoinedGroupIDs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Group_GetJoinedGroupIDs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetJoinedGroupIDsReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GroupServer).GetJoinedGroupIDs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/OpenIMServer.group.group/GetJoinedGroupIDs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GroupServer).GetJoinedGroupIDs(ctx, req.(*GetJoinedGroupIDsReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Group_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Group_GetJoinedGroupIDs_Handler,
		},
	},
