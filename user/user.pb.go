...
type AccountCheckRespSingleUserStatus struct {
	...
	UserID        string `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID"`
	AccountStatus bool   `protobuf:"varint,2,opt,name=accountStatus,proto3" json:"accountStatus"`
}
...
func (x *AccountCheckRespSingleUserStatus) GetAccountStatus() bool {
	if x != nil {
...
var file_user_user_proto_rawDesc = []byte{
	...
	0x6f, 0x75, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08,
