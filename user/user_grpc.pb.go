...
const (
	...
	User_UpdateUserInfoEx_FullMethodName              = "/OpenIMServer.user.user/updateUserInfoEx"
	...
	User_ProcessUserCommandAdd_FullMethodName         = "/OpenIMServer.user.user/processUserCommandAdd"
	User_ProcessUserCommandUpdate_FullMethodName      = "/OpenIMServer.user.user/processUserCommandUpdate"
	User_ProcessUserCommandDelete_FullMethodName      = "/OpenIMServer.user.user/processUserCommandDelete"
	User_ProcessUserCommandGet_FullMethodName         = "/OpenIMServer.user.user/processUserCommandGet"
	User_ProcessUserCommandGetAll_FullMethodName      = "/OpenIMServer.user.user/processUserCommandGetAll"
	User_AddNotificationAccount_FullMethodName        = "/OpenIMServer.user.user/addNotificationAccount"
	User_UpdateNotificationAccountInfo_FullMethodName = "/OpenIMServer.user.user/updateNotificationAccountInfo"
	User_SearchNotificationAccount_FullMethodName     = "/OpenIMServer.user.user/searchNotificationAccount"
	User_GetNotificationAccount_FullMethodName        = "/OpenIMServer.user.user/getNotificationAccount"
	User_GetGroupOnlineUser_FullMethodName            = "/OpenIMServer.user.user/getGroupOnlineUser"
)
...
func (c *userClient) GetGroupOnlineUser(ctx context.Context, in *GetGroupOnlineUserReq, opts ...grpc.CallOption) (*GetGroupOnlineUserResp, error) {
	...
	err := c.cc.Invoke(ctx, User_GetGroupOnlineUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _User_GetGroupOnlineUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_GetGroupOnlineUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
