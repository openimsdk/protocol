...
type GroupInfoSetTips struct {
	...
	Group    *GroupInfo           `protobuf:"bytes,3,opt,name=group,proto3" json:"group"` //  uint64 version = 4;
}
...
type GroupInfoSetNameTips struct {
	...
	OpUser *GroupMemberFullInfo `protobuf:"bytes,1,opt,name=opUser,proto3" json:"opUser"` //who do this
	Group  *GroupInfo           `protobuf:"bytes,2,opt,name=group,proto3" json:"group"`   //  uint64 version = 3;
}
...
type JoinGroupApplicationTips struct {
	...
	ReqMsg    string          `protobuf:"bytes,3,opt,name=reqMsg,proto3" json:"reqMsg"` //  uint64 version = 4;
}
...
var file_sdkws_sdkws_proto_rawDesc = []byte{
	...
	0xd4, 0x01, 0x0a, 0x0e, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x51, 0x75, 0x69, 0x74, 0x54, 0x69,
	...
	0x28, 0x04, 0x52, 0x12, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x56,
	0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0xc6, 0x01, 0x0a, 0x1c, 0x47, 0x72, 0x6f, 0x75, 0x70,
