...
const (
	...
	Msg_EditMessage_FullMethodName                      = "/openim.msg.msg/EditMessage"
	Msg_GetMessageEditHistory_FullMethodName            = "/openim.msg.msg/GetMessageEditHistory"
	Msg_ValidateEditPermission_FullMethodName           = "/openim.msg.msg/ValidateEditPermission"
	Msg_GetEditableMessages_FullMethodName              = "/openim.msg.msg/GetEditableMessages"
)
...
func (c *msgClient) EditMessage(ctx context.Context, in *EditMessageReq, opts ...grpc.CallOption) (*EditMessageResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EditMessageResp)
	err := c.cc.Invoke(ctx, Msg_EditMessage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) GetMessageEditHistory(ctx context.Context, in *GetMessageEditHistoryReq, opts ...grpc.CallOption) (*GetMessageEditHistoryResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetMessageEditHistoryResp)
	err := c.cc.Invoke(ctx, Msg_GetMessageEditHistory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ValidateEditPermission(ctx context.Context, in *ValidateEditPermissionReq, opts ...grpc.CallOption) (*ValidateEditPermissionResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ValidateEditPermissionResp)
	err := c.cc.Invoke(ctx, Msg_ValidateEditPermission_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) GetEditableMessages(ctx context.Context, in *GetEditableMessagesReq, opts ...grpc.CallOption) (*GetEditableMessagesResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetEditableMessagesResp)
	err := c.cc.Invoke(ctx, Msg_GetEditableMessages_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) EditMessage(context.Context, *EditMessageReq) (*EditMessageResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method EditMessage not implemented")
}
func (UnimplementedMsgServer) GetMessageEditHistory(context.Context, *GetMessageEditHistoryReq) (*GetMessageEditHistoryResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMessageEditHistory not implemented")
}
func (UnimplementedMsgServer) ValidateEditPermission(context.Context, *ValidateEditPermissionReq) (*ValidateEditPermissionResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ValidateEditPermission not implemented")
}
func (UnimplementedMsgServer) GetEditableMessages(context.Context, *GetEditableMessagesReq) (*GetEditableMessagesResp, error) {
...
func _Msg_EditMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EditMessageReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).EditMessage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_EditMessage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).EditMessage(ctx, req.(*EditMessageReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Msg_GetMessageEditHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetMessageEditHistoryReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).GetMessageEditHistory(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_GetMessageEditHistory_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).GetMessageEditHistory(ctx, req.(*GetMessageEditHistoryReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Msg_ValidateEditPermission_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ValidateEditPermissionReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).ValidateEditPermission(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_ValidateEditPermission_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).ValidateEditPermission(ctx, req.(*ValidateEditPermissionReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Msg_GetEditableMessages_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetEditableMessagesReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).GetEditableMessages(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_GetEditableMessages_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).GetEditableMessages(ctx, req.(*GetEditableMessagesReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Msg_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Msg_EditMessage_Handler,
		},
		{
			MethodName: "GetMessageEditHistory",
			Handler:    _Msg_GetMessageEditHistory_Handler,
		},
		{
			MethodName: "ValidateEditPermission",
			Handler:    _Msg_ValidateEditPermission_Handler,
		},
		{
			MethodName: "GetEditableMessages",
			Handler:    _Msg_GetEditableMessages_Handler,
		},
	},
