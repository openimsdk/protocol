...
type MessageEditClientInfo struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Platform      int32                  `protobuf:"varint,1,opt,name=platform,proto3" json:"platform"`    // 編輯平台 ID
	AppVersion    string                 `protobuf:"bytes,2,opt,name=appVersion,proto3" json:"appVersion"` // APP 版本
	IpAddress     string                 `protobuf:"bytes,3,opt,name=ipAddress,proto3" json:"ipAddress"`   // IP 地址
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type EditMessageReq struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	ConversationID string                 `protobuf:"bytes,1,opt,name=conversationID,proto3" json:"conversationID"` // 會話 ID
	Seq            int64                  `protobuf:"varint,2,opt,name=seq,proto3" json:"seq"`                      // 消息序列號
	NewContent     string                 `protobuf:"bytes,3,opt,name=newContent,proto3" json:"newContent"`         // 新的消息內容
	EditReason     string                 `protobuf:"bytes,4,opt,name=editReason,proto3" json:"editReason"`         // 編輯原因（可選）
	ClientInfo     *MessageEditClientInfo `protobuf:"bytes,5,opt,name=clientInfo,proto3" json:"clientInfo"`         // 客戶端信息
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type EditMessageResp struct {
	...
	Message        string                 `protobuf:"bytes,2,opt,name=message,proto3" json:"message"`               // 響應消息
	UpdatedMessage *EditedMessageInfo     `protobuf:"bytes,3,opt,name=updatedMessage,proto3" json:"updatedMessage"` // 更新後的消息信息
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type EditedMessageInfo struct {
	...
	ConversationID string                 `protobuf:"bytes,1,opt,name=conversationID,proto3" json:"conversationID"` // 會話 ID
	Seq            int64                  `protobuf:"varint,2,opt,name=seq,proto3" json:"seq"`                      // 消息序列號
	UserID         string                 `protobuf:"bytes,3,opt,name=userID,proto3" json:"userID"`                 // 編輯用戶 ID
	IsEdited       bool                   `protobuf:"varint,4,opt,name=isEdited,proto3" json:"isEdited"`            // 是否已編輯
	EditCount      int32                  `protobuf:"varint,5,opt,name=editCount,proto3" json:"editCount"`          // 編輯次數
	EditTime       int64                  `protobuf:"varint,6,opt,name=editTime,proto3" json:"editTime"`            // 編輯時間（毫秒時間戳）
	LastEditUserID string                 `protobuf:"bytes,7,opt,name=lastEditUserID,proto3" json:"lastEditUserID"` // 最後編輯者 ID
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type MessageEditRecord struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	EditID        string                 `protobuf:"bytes,1,opt,name=editID,proto3" json:"editID"`             // 編輯記錄 ID
	EditTime      int64                  `protobuf:"varint,2,opt,name=editTime,proto3" json:"editTime"`        // 編輯時間
	EditUserID    string                 `protobuf:"bytes,3,opt,name=editUserID,proto3" json:"editUserID"`     // 編輯者用戶 ID
	EditUserName  string                 `protobuf:"bytes,4,opt,name=editUserName,proto3" json:"editUserName"` // 編輯者用戶名
	OldContent    string                 `protobuf:"bytes,5,opt,name=oldContent,proto3" json:"oldContent"`     // 編輯前內容
	NewContent    string                 `protobuf:"bytes,6,opt,name=newContent,proto3" json:"newContent"`     // 編輯後內容
	EditReason    string                 `protobuf:"bytes,7,opt,name=editReason,proto3" json:"editReason"`     // 編輯原因
	ClientInfo    *MessageEditClientInfo `protobuf:"bytes,8,opt,name=clientInfo,proto3" json:"clientInfo"`     // 客戶端信息
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetMessageEditHistoryResp struct {
	...
	Success       bool                   `protobuf:"varint,1,opt,name=success,proto3" json:"success"`        // 是否成功
	Message       string                 `protobuf:"bytes,2,opt,name=message,proto3" json:"message"`         // 響應消息
	EditHistory   []*MessageEditRecord   `protobuf:"bytes,3,rep,name=editHistory,proto3" json:"editHistory"` // 編輯歷史記錄
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ValidateEditPermissionResp struct {
	...
	Success       bool                   `protobuf:"varint,1,opt,name=success,proto3" json:"success"` // 是否成功
	Message       string                 `protobuf:"bytes,2,opt,name=message,proto3" json:"message"`  // 響應消息
	Data          *PermissionResult      `protobuf:"bytes,3,opt,name=data,proto3" json:"data"`        // 權限驗證結果
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type PermissionResult struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	CanEdit       bool                   `protobuf:"varint,1,opt,name=canEdit,proto3" json:"canEdit"`             // 是否可以編輯
	Reason        string                 `protobuf:"bytes,2,opt,name=reason,proto3" json:"reason"`                // 不能編輯的原因（如果 canEdit 為 false）
	TimeRemaining int64                  `protobuf:"varint,3,opt,name=timeRemaining,proto3" json:"timeRemaining"` // 剩餘編輯時間（秒）
	EditCountLeft int32                  `protobuf:"varint,4,opt,name=editCountLeft,proto3" json:"editCountLeft"` // 剩餘編輯次數
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetEditableMessagesReq struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	ConversationID string                 `protobuf:"bytes,1,opt,name=conversationID,proto3" json:"conversationID"` // 會話 ID
	PageNumber     int32                  `protobuf:"varint,2,opt,name=pageNumber,proto3" json:"pageNumber"`        // 頁碼
	ShowNumber     int32                  `protobuf:"varint,3,opt,name=showNumber,proto3" json:"showNumber"`        // 每頁數量
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type EditableMessageInfo struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	Seq             int64                  `protobuf:"varint,1,opt,name=seq,proto3" json:"seq"`                        // 消息序列號
	Content         string                 `protobuf:"bytes,2,opt,name=content,proto3" json:"content"`                 // 消息內容
	ContentType     int32                  `protobuf:"varint,3,opt,name=contentType,proto3" json:"contentType"`        // 內容類型
	SendTime        int64                  `protobuf:"varint,4,opt,name=sendTime,proto3" json:"sendTime"`              // 發送時間
	IsEdited        bool                   `protobuf:"varint,5,opt,name=isEdited,proto3" json:"isEdited"`              // 是否已編輯
	EditCount       int32                  `protobuf:"varint,6,opt,name=editCount,proto3" json:"editCount"`            // 編輯次數
	LastEditTime    int64                  `protobuf:"varint,7,opt,name=lastEditTime,proto3" json:"lastEditTime"`      // 最後編輯時間
	LastEditUserID  string                 `protobuf:"bytes,8,opt,name=lastEditUserID,proto3" json:"lastEditUserID"`   // 最後編輯者 ID
	OriginalContent string                 `protobuf:"bytes,9,opt,name=originalContent,proto3" json:"originalContent"` // 原始內容
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type PaginationInfo struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	PageNumber    int32                  `protobuf:"varint,1,opt,name=pageNumber,proto3" json:"pageNumber"` // 當前頁碼
	ShowNumber    int32                  `protobuf:"varint,2,opt,name=showNumber,proto3" json:"showNumber"` // 每頁數量
	Total         int64                  `protobuf:"varint,3,opt,name=total,proto3" json:"total"`           // 總數量
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetEditableMessagesResp struct {
	...
	Success        bool                   `protobuf:"varint,1,opt,name=success,proto3" json:"success"`              // 是否成功
	Message        string                 `protobuf:"bytes,2,opt,name=message,proto3" json:"message"`               // 響應消息
	ConversationID string                 `protobuf:"bytes,3,opt,name=conversationID,proto3" json:"conversationID"` // 會話 ID
	Messages       []*EditableMessageInfo `protobuf:"bytes,4,rep,name=messages,proto3" json:"messages"`             // 可編輯消息列表
	Pagination     *PaginationInfo        `protobuf:"bytes,5,opt,name=pagination,proto3" json:"pagination"`         // 分頁信息
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type EditNotificationData struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	NotificationType string                 `protobuf:"bytes,1,opt,name=notificationType,proto3" json:"notificationType"` // 通知類型（messageEdit）
	ConversationID   string                 `protobuf:"bytes,2,opt,name=conversationID,proto3" json:"conversationID"`     // 會話 ID
	Seq              int64                  `protobuf:"varint,3,opt,name=seq,proto3" json:"seq"`                          // 消息序列號
	EditTime         int64                  `protobuf:"varint,4,opt,name=editTime,proto3" json:"editTime"`                // 編輯時間
	EditorUserID     string                 `protobuf:"bytes,5,opt,name=editorUserID,proto3" json:"editorUserID"`         // 編輯者用戶 ID
	NewContent       string                 `protobuf:"bytes,6,opt,name=newContent,proto3" json:"newContent"`             // 新內容
	IsEdited         bool                   `protobuf:"varint,7,opt,name=isEdited,proto3" json:"isEdited"`                // 是否已編輯
	EditCount        int32                  `protobuf:"varint,8,opt,name=editCount,proto3" json:"editCount"`              // 編輯次數
	OriginalSender   string                 `protobuf:"bytes,9,opt,name=originalSender,proto3" json:"originalSender"`     // 原始發送者 ID
	MsgType          int32                  `protobuf:"varint,10,opt,name=msgType,proto3" json:"msgType"`                 // 消息類型
	ClientMsgID      string                 `protobuf:"bytes,11,opt,name=clientMsgID,proto3" json:"clientMsgID"`          // 客戶端消息 ID
	ServerMsgID      string                 `protobuf:"bytes,12,opt,name=serverMsgID,proto3" json:"serverMsgID"`          // 服務器消息 ID
	CreateTime       int64                  `protobuf:"varint,13,opt,name=createTime,proto3" json:"createTime"`           // 創建時間
	SendTime         int64                  `protobuf:"varint,14,opt,name=sendTime,proto3" json:"sendTime"`               // 發送時間
	SessionType      int32                  `protobuf:"varint,15,opt,name=sessionType,proto3" json:"sessionType"`         // 會話類型
	UpdatedMessage   *EditedMessageInfo     `protobuf:"bytes,16,opt,name=updatedMessage,proto3" json:"updatedMessage"`    // 完整的更新後消息數據
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
const file_msg_msg_proto_rawDesc = "" +
	...
	"\tMsgsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12+\n" +
	"\x05value\x18\x02 \x01(\v2\x15.openim.sdkws.MsgDataR\x05value:\x028\x01\"q\n" +
	"\x15MessageEditClientInfo\x12\x1a\n" +
	"\bplatform\x18\x01 \x01(\x05R\bplatform\x12\x1e\n" +
	"\n" +
	"appVersion\x18\x02 \x01(\tR\n" +
	"appVersion\x12\x1c\n" +
	"\tipAddress\x18\x03 \x01(\tR\tipAddress\"\xcd\x01\n" +
	...
	"newContent\x12\x1e\n" +
	"\n" +
	"editReason\x18\x04 \x01(\tR\n" +
	"editReason\x12A\n" +
	"\n" +
	"clientInfo\x18\x05 \x01(\v2!.openim.msg.MessageEditClientInfoR\n" +
	"clientInfo\"\x8c\x01\n" +
	"\x0fEditMessageResp\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12E\n" +
	"\x0eupdatedMessage\x18\x03 \x01(\v2\x1d.openim.msg.EditedMessageInfoR\x0eupdatedMessage\"\xe3\x01\n" +
	"\x11EditedMessageInfo\x12&\n" +
	"\x0econversationID\x18\x01 \x01(\tR\x0econversationID\x12\x10\n" +
	"\x03seq\x18\x02 \x01(\x03R\x03seq\x12\x16\n" +
	"\x06userID\x18\x03 \x01(\tR\x06userID\x12\x1a\n" +
	"\bisEdited\x18\x04 \x01(\bR\bisEdited\x12\x1c\n" +
	"\teditCount\x18\x05 \x01(\x05R\teditCount\x12\x1a\n" +
	"\beditTime\x18\x06 \x01(\x03R\beditTime\x12&\n" +
	"\x0elastEditUserID\x18\a \x01(\tR\x0elastEditUserID\"\xae\x02\n" +
	"\x11MessageEditRecord\x12\x16\n" +
	"\x06editID\x18\x01 \x01(\tR\x06editID\x12\x1a\n" +
	"\beditTime\x18\x02 \x01(\x03R\beditTime\x12\x1e\n" +
	"\n" +
	"editUserID\x18\x03 \x01(\tR\n" +
	"editUserID\x12\"\n" +
	"\feditUserName\x18\x04 \x01(\tR\feditUserName\x12\x1e\n" +
	"\n" +
	"oldContent\x18\x05 \x01(\tR\n" +
	"oldContent\x12\x1e\n" +
	"\n" +
	"newContent\x18\x06 \x01(\tR\n" +
	"newContent\x12\x1e\n" +
	"\n" +
	"editReason\x18\a \x01(\tR\n" +
	"editReason\x12A\n" +
	"\n" +
	"clientInfo\x18\b \x01(\v2!.openim.msg.MessageEditClientInfoR\n" +
	"clientInfo\"T\n" +
	"\x18GetMessageEditHistoryReq\x12&\n" +
	"\x0econversationID\x18\x01 \x01(\tR\x0econversationID\x12\x10\n" +
	"\x03seq\x18\x02 \x01(\x03R\x03seq\"\x90\x01\n" +
	"\x19GetMessageEditHistoryResp\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12?\n" +
	"\veditHistory\x18\x03 \x03(\v2\x1d.openim.msg.MessageEditRecordR\veditHistory\"U\n" +
	"\x19ValidateEditPermissionReq\x12&\n" +
	"\x0econversationID\x18\x01 \x01(\tR\x0econversationID\x12\x10\n" +
	"\x03seq\x18\x02 \x01(\x03R\x03seq\"\x82\x01\n" +
	"\x1aValidateEditPermissionResp\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x120\n" +
	"\x04data\x18\x03 \x01(\v2\x1c.openim.msg.PermissionResultR\x04data\"\x90\x01\n" +
	"\x10PermissionResult\x12\x18\n" +
	"\acanEdit\x18\x01 \x01(\bR\acanEdit\x12\x16\n" +
	"\x06reason\x18\x02 \x01(\tR\x06reason\x12$\n" +
	"\rtimeRemaining\x18\x03 \x01(\x03R\rtimeRemaining\x12$\n" +
	"\reditCountLeft\x18\x04 \x01(\x05R\reditCountLeft\"\x80\x01\n" +
	...
	"\bisEdited\x18\x05 \x01(\bR\bisEdited\x12\x1c\n" +
	"\teditCount\x18\x06 \x01(\x05R\teditCount\x12\"\n" +
	"\flastEditTime\x18\a \x01(\x03R\flastEditTime\x12&\n" +
	"\x0elastEditUserID\x18\b \x01(\tR\x0elastEditUserID\x12(\n" +
	"\x0foriginalContent\x18\t \x01(\tR\x0foriginalContent\"f\n" +
	"\x0ePaginationInfo\x12\x1e\n" +
	"\n" +
	...
	"\bmessages\x18\x04 \x03(\v2\x1f.openim.msg.EditableMessageInfoR\bmessages\x12:\n" +
	"\n" +
	"pagination\x18\x05 \x01(\v2\x1a.openim.msg.PaginationInfoR\n" +
	"pagination\"\xc1\x04\n" +
	"\x14EditNotificationData\x12*\n" +
	"\x10notificationType\x18\x01 \x01(\tR\x10notificationType\x12&\n" +
	"\x0econversationID\x18\x02 \x01(\tR\x0econversationID\x12\x10\n" +
	"\x03seq\x18\x03 \x01(\x03R\x03seq\x12\x1a\n" +
	"\beditTime\x18\x04 \x01(\x03R\beditTime\x12\"\n" +
	"\feditorUserID\x18\x05 \x01(\tR\feditorUserID\x12\x1e\n" +
	"\n" +
	"newContent\x18\x06 \x01(\tR\n" +
	"newContent\x12\x1a\n" +
	"\bisEdited\x18\a \x01(\bR\bisEdited\x12\x1c\n" +
	"\teditCount\x18\b \x01(\x05R\teditCount\x12&\n" +
	"\x0eoriginalSender\x18\t \x01(\tR\x0eoriginalSender\x12\x18\n" +
	"\amsgType\x18\n" +
	" \x01(\x05R\amsgType\x12 \n" +
	"\vclientMsgID\x18\v \x01(\tR\vclientMsgID\x12 \n" +
	"\vserverMsgID\x18\f \x01(\tR\vserverMsgID\x12\x1e\n" +
	"\n" +
	"createTime\x18\r \x01(\x03R\n" +
	"createTime\x12\x1a\n" +
	"\bsendTime\x18\x0e \x01(\x03R\bsendTime\x12 \n" +
	"\vsessionType\x18\x0f \x01(\x05R\vsessionType\x12E\n" +
	"\x0eupdatedMessage\x18\x10 \x01(\v2\x1d.openim.msg.EditedMessageInfoR\x0eupdatedMessage2\xff\x19\n" +
	"\x03msg\x12D\n" +
	...
	"\vEditMessage\x12\x1a.openim.msg.EditMessageReq\x1a\x1b.openim.msg.EditMessageResp\x12d\n" +
	"\x15GetMessageEditHistory\x12$.openim.msg.GetMessageEditHistoryReq\x1a%.openim.msg.GetMessageEditHistoryResp\x12g\n" +
	"\x16ValidateEditPermission\x12%.openim.msg.ValidateEditPermissionReq\x1a&.openim.msg.ValidateEditPermissionResp\x12^\n" +
	"\x13GetEditableMessages\x12\".openim.msg.GetEditableMessagesReq\x1a#.openim.msg.GetEditableMessagesRespB#Z!github.com/openimsdk/protocol/msgb\x06proto3"
...
var file_msg_msg_proto_msgTypes = make([]protoimpl.MessageInfo, 105)
var file_msg_msg_proto_goTypes = []any{
	...
	(*MessageEditClientInfo)(nil),                // 81: openim.msg.MessageEditClientInfo
	(*EditMessageReq)(nil),                       // 82: openim.msg.EditMessageReq
	(*EditMessageResp)(nil),                      // 83: openim.msg.EditMessageResp
	(*EditedMessageInfo)(nil),                    // 84: openim.msg.EditedMessageInfo
	(*MessageEditRecord)(nil),                    // 85: openim.msg.MessageEditRecord
	(*GetMessageEditHistoryReq)(nil),             // 86: openim.msg.GetMessageEditHistoryReq
	(*GetMessageEditHistoryResp)(nil),            // 87: openim.msg.GetMessageEditHistoryResp
	(*ValidateEditPermissionReq)(nil),            // 88: openim.msg.ValidateEditPermissionReq
	(*ValidateEditPermissionResp)(nil),           // 89: openim.msg.ValidateEditPermissionResp
	(*PermissionResult)(nil),                     // 90: openim.msg.PermissionResult
	(*GetEditableMessagesReq)(nil),               // 91: openim.msg.GetEditableMessagesReq
	(*EditableMessageInfo)(nil),                  // 92: openim.msg.EditableMessageInfo
	(*PaginationInfo)(nil),                       // 93: openim.msg.PaginationInfo
	(*GetEditableMessagesResp)(nil),              // 94: openim.msg.GetEditableMessagesResp
	(*EditNotificationData)(nil),                 // 95: openim.msg.EditNotificationData
	nil,                                          // 96: openim.msg.SeqsInfoResp.MaxSeqsEntry
	nil,                                          // 97: openim.msg.GetMsgByConversationIDsReq.MaxSeqsEntry
	nil,                                          // 98: openim.msg.GetMsgByConversationIDsResp.MsgDatasEntry
	nil,                                          // 99: openim.msg.GetConversationsHasReadAndMaxSeqResp.SeqsEntry
	nil,                                          // 100: openim.msg.GetActiveUserResp.DateCountEntry
	nil,                                          // 101: openim.msg.GetActiveGroupResp.DateCountEntry
	nil,                                          // 102: openim.msg.GetSeqMessageResp.MsgsEntry
	nil,                                          // 103: openim.msg.GetSeqMessageResp.NotificationMsgsEntry
	nil,                                          // 104: openim.msg.GetLastMessageResp.MsgsEntry
	(*sdkws.MsgData)(nil),                        // 105: openim.sdkws.MsgData
	...
	(sdkws.PullOrder)(0),                         // 110: openim.sdkws.PullOrder
	(*sdkws.PullMsgs)(nil),                       // 111: openim.sdkws.PullMsgs
	(*sdkws.GetMaxSeqReq)(nil),                   // 112: openim.sdkws.GetMaxSeqReq
	(*sdkws.PullMessageBySeqsReq)(nil),           // 113: openim.sdkws.PullMessageBySeqsReq
	(*sdkws.GetMaxSeqResp)(nil),                  // 114: openim.sdkws.GetMaxSeqResp
	(*sdkws.PullMessageBySeqsResp)(nil),          // 115: openim.sdkws.PullMessageBySeqsResp
}
var file_msg_msg_proto_depIdxs = []int32{
	105, // 0: openim.msg.MsgDataToMQ.msgData:type_name -> openim.sdkws.MsgData
	105, // 1: openim.msg.MsgDataToDB.msgData:type_name -> openim.sdkws.MsgData
	105, // 2: openim.msg.PushMsgDataToMQ.msgData:type_name -> openim.sdkws.MsgData
	105, // 3: openim.msg.MsgDataToMongoByMQ.msgData:type_name -> openim.sdkws.MsgData
	105, // 4: openim.msg.SendMsgReq.msgData:type_name -> openim.sdkws.MsgData
	105, // 5: openim.msg.SendMsgResp.modify:type_name -> openim.sdkws.MsgData
	105, // 6: openim.msg.SendSimpleMsgReq.msgData:type_name -> openim.sdkws.MsgData
	105, // 7: openim.msg.SendSimpleMsgResp.modify:type_name -> openim.sdkws.MsgData
	105, // 8: openim.msg.MsgDataToModifyByMQ.messages:type_name -> openim.sdkws.MsgData
	...
	96,  // 12: openim.msg.SeqsInfoResp.maxSeqs:type_name -> openim.msg.SeqsInfoResp.MaxSeqsEntry
	97,  // 13: openim.msg.GetMsgByConversationIDsReq.maxSeqs:type_name -> openim.msg.GetMsgByConversationIDsReq.MaxSeqsEntry
	98,  // 14: openim.msg.GetMsgByConversationIDsResp.msgDatas:type_name -> openim.msg.GetMsgByConversationIDsResp.MsgDatasEntry
	99,  // 15: openim.msg.GetConversationsHasReadAndMaxSeqResp.seqs:type_name -> openim.msg.GetConversationsHasReadAndMaxSeqResp.SeqsEntry
	106, // 16: openim.msg.GetActiveUserReq.pagination:type_name -> openim.sdkws.RequestPagination
	107, // 17: openim.msg.ActiveUser.user:type_name -> openim.sdkws.UserInfo
	100, // 18: openim.msg.GetActiveUserResp.dateCount:type_name -> openim.msg.GetActiveUserResp.DateCountEntry
	47,  // 19: openim.msg.GetActiveUserResp.users:type_name -> openim.msg.ActiveUser
	106, // 20: openim.msg.GetActiveGroupReq.pagination:type_name -> openim.sdkws.RequestPagination
	108, // 21: openim.msg.ActiveGroup.group:type_name -> openim.sdkws.GroupInfo
	101, // 22: openim.msg.GetActiveGroupResp.dateCount:type_name -> openim.msg.GetActiveGroupResp.DateCountEntry
	50,  // 23: openim.msg.GetActiveGroupResp.groups:type_name -> openim.msg.ActiveGroup
	106, // 24: openim.msg.SearchMessageReq.pagination:type_name -> openim.sdkws.RequestPagination
	56,  // 25: openim.msg.SearchChatLog.chatLog:type_name -> openim.msg.ChatLog
	105, // 26: openim.msg.SearchedMsgData.msgData:type_name -> openim.sdkws.MsgData
	53,  // 27: openim.msg.SearchMessageResp.chatLogs:type_name -> openim.msg.SearchChatLog
	105, // 28: openim.msg.batchSendMessageReq.msgData:type_name -> openim.sdkws.MsgData
	109, // 29: openim.msg.ClearMsgReq.conversations:type_name -> openim.conversation.Conversation
	67,  // 30: openim.msg.GetSeqMessageReq.conversations:type_name -> openim.msg.ConversationSeqs
	110, // 31: openim.msg.GetSeqMessageReq.order:type_name -> openim.sdkws.PullOrder
	102, // 32: openim.msg.GetSeqMessageResp.msgs:type_name -> openim.msg.GetSeqMessageResp.MsgsEntry
	103, // 33: openim.msg.GetSeqMessageResp.notificationMsgs:type_name -> openim.msg.GetSeqMessageResp.NotificationMsgsEntry
	71,  // 34: openim.msg.GetActiveConversationResp.conversations:type_name -> openim.msg.ActiveConversation
	104, // 35: openim.msg.GetLastMessageResp.msgs:type_name -> openim.msg.GetLastMessageResp.MsgsEntry
	81,  // 36: openim.msg.EditMessageReq.clientInfo:type_name -> openim.msg.MessageEditClientInfo
	84,  // 37: openim.msg.EditMessageResp.updatedMessage:type_name -> openim.msg.EditedMessageInfo
	81,  // 38: openim.msg.MessageEditRecord.clientInfo:type_name -> openim.msg.MessageEditClientInfo
	85,  // 39: openim.msg.GetMessageEditHistoryResp.editHistory:type_name -> openim.msg.MessageEditRecord
	90,  // 40: openim.msg.ValidateEditPermissionResp.data:type_name -> openim.msg.PermissionResult
	92,  // 41: openim.msg.GetEditableMessagesResp.messages:type_name -> openim.msg.EditableMessageInfo
	93,  // 42: openim.msg.GetEditableMessagesResp.pagination:type_name -> openim.msg.PaginationInfo
	84,  // 43: openim.msg.EditNotificationData.updatedMessage:type_name -> openim.msg.EditedMessageInfo
	105, // 44: openim.msg.GetMsgByConversationIDsResp.MsgDatasEntry.value:type_name -> openim.sdkws.MsgData
	44,  // 45: openim.msg.GetConversationsHasReadAndMaxSeqResp.SeqsEntry.value:type_name -> openim.msg.Seqs
	111, // 46: openim.msg.GetSeqMessageResp.MsgsEntry.value:type_name -> openim.sdkws.PullMsgs
	111, // 47: openim.msg.GetSeqMessageResp.NotificationMsgsEntry.value:type_name -> openim.sdkws.PullMsgs
	105, // 48: openim.msg.GetLastMessageResp.MsgsEntry.value:type_name -> openim.sdkws.MsgData
	112, // 49: openim.msg.msg.GetMaxSeq:input_type -> openim.sdkws.GetMaxSeqReq
	36,  // 50: openim.msg.msg.GetMaxSeqs:input_type -> openim.msg.GetMaxSeqsReq
	37,  // 51: openim.msg.msg.GetHasReadSeqs:input_type -> openim.msg.GetHasReadSeqsReq
	39,  // 52: openim.msg.msg.GetMsgByConversationIDs:input_type -> openim.msg.GetMsgByConversationIDsReq
	41,  // 53: openim.msg.msg.GetConversationMaxSeq:input_type -> openim.msg.GetConversationMaxSeqReq
	113, // 54: openim.msg.msg.PullMessageBySeqs:input_type -> openim.sdkws.PullMessageBySeqsReq
	68,  // 55: openim.msg.msg.GetSeqMessage:input_type -> openim.msg.GetSeqMessageReq
	52,  // 56: openim.msg.msg.SearchMessage:input_type -> openim.msg.SearchMessageReq
	...
	65,  // 59: openim.msg.msg.SetUserConversationsMinSeq:input_type -> openim.msg.SetUserConversationsMinSeqReq
	26,  // 60: openim.msg.msg.ClearConversationsMsg:input_type -> openim.msg.ClearConversationsMsgReq
	28,  // 61: openim.msg.msg.UserClearAllMsg:input_type -> openim.msg.UserClearAllMsgReq
	30,  // 62: openim.msg.msg.DeleteMsgs:input_type -> openim.msg.DeleteMsgsReq
	34,  // 63: openim.msg.msg.DeleteMsgPhysicalBySeq:input_type -> openim.msg.DeleteMsgPhysicalBySeqReq
	32,  // 64: openim.msg.msg.DeleteMsgPhysical:input_type -> openim.msg.DeleteMsgPhysicalReq
	...
	23,  // 70: openim.msg.msg.SetConversationHasReadSeq:input_type -> openim.msg.SetConversationHasReadSeqReq
	43,  // 71: openim.msg.msg.GetConversationsHasReadAndMaxSeq:input_type -> openim.msg.GetConversationsHasReadAndMaxSeqReq
	46,  // 72: openim.msg.msg.GetActiveUser:input_type -> openim.msg.GetActiveUserReq
	49,  // 73: openim.msg.msg.GetActiveGroup:input_type -> openim.msg.GetActiveGroupReq
	59,  // 74: openim.msg.msg.GetServerTime:input_type -> openim.msg.GetServerTimeReq
	61,  // 75: openim.msg.msg.ClearMsg:input_type -> openim.msg.ClearMsgReq
	63,  // 76: openim.msg.msg.DestructMsgs:input_type -> openim.msg.DestructMsgsReq
	70,  // 77: openim.msg.msg.GetActiveConversation:input_type -> openim.msg.GetActiveConversationReq
	73,  // 78: openim.msg.msg.SetUserConversationMaxSeq:input_type -> openim.msg.SetUserConversationMaxSeqReq
	75,  // 79: openim.msg.msg.SetUserConversationMinSeq:input_type -> openim.msg.SetUserConversationMinSeqReq
	77,  // 80: openim.msg.msg.GetLastMessageSeqByTime:input_type -> openim.msg.GetLastMessageSeqByTimeReq
	79,  // 81: openim.msg.msg.GetLastMessage:input_type -> openim.msg.GetLastMessageReq
	82,  // 82: openim.msg.msg.EditMessage:input_type -> openim.msg.EditMessageReq
	86,  // 83: openim.msg.msg.GetMessageEditHistory:input_type -> openim.msg.GetMessageEditHistoryReq
	88,  // 84: openim.msg.msg.ValidateEditPermission:input_type -> openim.msg.ValidateEditPermissionReq
	91,  // 85: openim.msg.msg.GetEditableMessages:input_type -> openim.msg.GetEditableMessagesReq
	114, // 86: openim.msg.msg.GetMaxSeq:output_type -> openim.sdkws.GetMaxSeqResp
	38,  // 87: openim.msg.msg.GetMaxSeqs:output_type -> openim.msg.SeqsInfoResp
	38,  // 88: openim.msg.msg.GetHasReadSeqs:output_type -> openim.msg.SeqsInfoResp
	40,  // 89: openim.msg.msg.GetMsgByConversationIDs:output_type -> openim.msg.GetMsgByConversationIDsResp
	42,  // 90: openim.msg.msg.GetConversationMaxSeq:output_type -> openim.msg.GetConversationMaxSeqResp
	115, // 91: openim.msg.msg.PullMessageBySeqs:output_type -> openim.sdkws.PullMessageBySeqsResp
	69,  // 92: openim.msg.msg.GetSeqMessage:output_type -> openim.msg.GetSeqMessageResp
	55,  // 93: openim.msg.msg.SearchMessage:output_type -> openim.msg.SearchMessageResp
	7,   // 94: openim.msg.msg.SendMsg:output_type -> openim.msg.SendMsgResp
	9,   // 95: openim.msg.msg.SendSimpleMsg:output_type -> openim.msg.SendSimpleMsgResp
	66,  // 96: openim.msg.msg.SetUserConversationsMinSeq:output_type -> openim.msg.SetUserConversationsMinSeqResp
	27,  // 97: openim.msg.msg.ClearConversationsMsg:output_type -> openim.msg.ClearConversationsMsgResp
	29,  // 98: openim.msg.msg.UserClearAllMsg:output_type -> openim.msg.UserClearAllMsgResp
	31,  // 99: openim.msg.msg.DeleteMsgs:output_type -> openim.msg.DeleteMsgsResp
	35,  // 100: openim.msg.msg.DeleteMsgPhysicalBySeq:output_type -> openim.msg.DeleteMsgPhysicalBySeqResp
	33,  // 101: openim.msg.msg.DeleteMsgPhysical:output_type -> openim.msg.DeleteMsgPhysicalResp
	11,  // 102: openim.msg.msg.SetSendMsgStatus:output_type -> openim.msg.SetSendMsgStatusResp
	13,  // 103: openim.msg.msg.GetSendMsgStatus:output_type -> openim.msg.GetSendMsgStatusResp
	18,  // 104: openim.msg.msg.RevokeMsg:output_type -> openim.msg.RevokeMsgResp
	20,  // 105: openim.msg.msg.MarkMsgsAsRead:output_type -> openim.msg.MarkMsgsAsReadResp
	22,  // 106: openim.msg.msg.MarkConversationAsRead:output_type -> openim.msg.MarkConversationAsReadResp
	24,  // 107: openim.msg.msg.SetConversationHasReadSeq:output_type -> openim.msg.SetConversationHasReadSeqResp
	45,  // 108: openim.msg.msg.GetConversationsHasReadAndMaxSeq:output_type -> openim.msg.GetConversationsHasReadAndMaxSeqResp
	48,  // 109: openim.msg.msg.GetActiveUser:output_type -> openim.msg.GetActiveUserResp
	51,  // 110: openim.msg.msg.GetActiveGroup:output_type -> openim.msg.GetActiveGroupResp
	60,  // 111: openim.msg.msg.GetServerTime:output_type -> openim.msg.GetServerTimeResp
	62,  // 112: openim.msg.msg.ClearMsg:output_type -> openim.msg.ClearMsgResp
	64,  // 113: openim.msg.msg.DestructMsgs:output_type -> openim.msg.DestructMsgsResp
	72,  // 114: openim.msg.msg.GetActiveConversation:output_type -> openim.msg.GetActiveConversationResp
	74,  // 115: openim.msg.msg.SetUserConversationMaxSeq:output_type -> openim.msg.SetUserConversationMaxSeqResp
	76,  // 116: openim.msg.msg.SetUserConversationMinSeq:output_type -> openim.msg.SetUserConversationMinSeqResp
	78,  // 117: openim.msg.msg.GetLastMessageSeqByTime:output_type -> openim.msg.GetLastMessageSeqByTimeResp
	80,  // 118: openim.msg.msg.GetLastMessage:output_type -> openim.msg.GetLastMessageResp
	83,  // 119: openim.msg.msg.EditMessage:output_type -> openim.msg.EditMessageResp
	87,  // 120: openim.msg.msg.GetMessageEditHistory:output_type -> openim.msg.GetMessageEditHistoryResp
	89,  // 121: openim.msg.msg.ValidateEditPermission:output_type -> openim.msg.ValidateEditPermissionResp
	94,  // 122: openim.msg.msg.GetEditableMessages:output_type -> openim.msg.GetEditableMessagesResp
