...
type DeleteOutdatedDataReq struct {
	...
	ExpireTime string `protobuf:"bytes,1,opt,name=expireTime,proto3" json:"expireTime"`
}
...
func (x *DeleteOutdatedDataReq) GetExpireTime() string {
	if x != nil {
		return x.ExpireTime
	}
	return ""
...
var file_third_third_proto_rawDesc = []byte{
	...
	0x65, 0x78, 0x70, 0x69, 0x72, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
