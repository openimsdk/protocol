...
const file_auth_auth_proto_rawDesc = "" +
	...
	"\x10getExistingToken\x12 .openim.auth.GetExistingTokenReq\x1a!.openim.auth.getExistingTokenResp\x12L\n" +
	"\x0fforceLogoutTest\x12\x1b.openim.auth.forceLogoutReq\x1a\x1c.openim.auth.forceLogoutRespB$Z\"github.com/openimsdk/protocol/authb\x06proto3"
...
var file_auth_auth_proto_depIdxs = []int32{
	...
	2,  // 8: openim.auth.Auth.forceLogoutTest:input_type -> openim.auth.forceLogoutReq
	1,  // 9: openim.auth.Auth.getAdminToken:output_type -> openim.auth.getAdminTokenResp
	7,  // 10: openim.auth.Auth.getUserToken:output_type -> openim.auth.getUserTokenResp
	3,  // 11: openim.auth.Auth.forceLogout:output_type -> openim.auth.forceLogoutResp
	5,  // 12: openim.auth.Auth.parseToken:output_type -> openim.auth.parseTokenResp
	9,  // 13: openim.auth.Auth.invalidateToken:output_type -> openim.auth.invalidateTokenResp
	11, // 14: openim.auth.Auth.kickTokens:output_type -> openim.auth.kickTokensResp
	13, // 15: openim.auth.Auth.getExistingToken:output_type -> openim.auth.getExistingTokenResp
	3,  // 16: openim.auth.Auth.forceLogoutTest:output_type -> openim.auth.forceLogoutResp
