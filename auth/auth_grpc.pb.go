...
const (
	...
	Auth_ForceLogoutTest_FullMethodName  = "/openim.auth.Auth/forceLogoutTest"
)
...
type AuthClient interface {
	...
	ForceLogoutTest(ctx context.Context, in *ForceLogoutReq, opts ...grpc.CallOption) (*ForceLogoutResp, error)
}
...
func (c *authClient) ForceLogoutTest(ctx context.Context, in *ForceLogoutReq, opts ...grpc.CallOption) (*ForceLogoutResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ForceLogoutResp)
	err := c.cc.Invoke(ctx, Auth_ForceLogoutTest_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServer interface {
	...
	ForceLogoutTest(context.Context, *ForceLogoutReq) (*ForceLogoutResp, error)
...
func (UnimplementedAuthServer) ForceLogoutTest(context.Context, *ForceLogoutReq) (*ForceLogoutResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ForceLogoutTest not implemented")
}
...
func _Auth_ForceLogoutTest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ForceLogoutReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).ForceLogoutTest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Auth_ForceLogoutTest_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).ForceLogoutTest(ctx, req.(*ForceLogoutReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "forceLogoutTest",
			Handler:    _Auth_ForceLogoutTest_Handler,
		},
	},
